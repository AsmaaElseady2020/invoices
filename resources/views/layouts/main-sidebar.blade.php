<!-- main-sidebar -->
	...
	@can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='UnPaid_invoice') }}">الفواتير الغير مدفوعه</a></li>
							@endcan


							@can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ url('/' . $page='Partial_invoice') }}">الفواتير المدفوعه جزئيا</a></li>
							@endcan

							
							@can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='show_archive_invoice') }}">  ارشيف الفواتير</a></li>
							@endcan
						</ul>
					...
					<li class="slide">
						...
						@can('تقرير الفواتير')
							...
							@can('تقرير العملاء')
							<li><a class="slide-item" href="{{ url('/' . $page='report_customers') }}">تقارير العملاء</a></li>
							@endcan
						</ul>
					</li>
					@endcan
					...
					@can('الاقسام')
							<li><a class="slide-item" href="{{ url('/' . $page='productes') }}">المنتجات </a></li>
