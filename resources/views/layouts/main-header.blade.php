								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="\markasread">تعيين قراءه الكل </a></span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">  
											عددالاشعارات الغير مقرؤه   <strong  style="color:yellow;" id="notifications_count">{{auth()->User()->unreadNotifications->count()}} </strong></div>
										</p>
									...
									@foreach(auth()->User()->unreadNotifications as $notification)
										...
										<div class="notifyimg bg-pink">
											...
											<div class="mr-3">
												...
												<h5 class="notification-label mb-1">{{ $notification->data['title']}}<strong>{{ $notification->data['user']}}</strong></h5>
