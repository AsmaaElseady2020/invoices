...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الفواتير الغير مدفوعه \</span>
						</div>
					</div>
...
@if (session()->has('archive_invoice'))
 ...
 <td>
	...
	<div class="dropdown-menu tx-13">
		<a class="dropdown-item" href="{{url('editeinvoice')}}/{{$invoice->id}}">تعديل الفاتوره</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ route('deleteinvoice', 'test') }}" method="post">
                        {{ method_field('delete') }}
                        {{ csrf_field() }}
                </div>
